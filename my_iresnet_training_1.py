...
def train():
    ...
    model_path='../Dataset/211022_Data/Images/Training_1_1000_H/Results/model_{}_{}.pt'.format(resize,d.strftime('%y%m%d'))
    model=load_model()
    ...
    for epoch in tqdm(range(epochs)):
        ...
        test_loss,test_acc=evaluate_model(model,val_loader,criterion,model_path)
